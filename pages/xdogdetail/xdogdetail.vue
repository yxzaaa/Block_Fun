<template>
	<view class="container">
		<uni-background />
		<uni-nav-bar title="详情" textColor="#fff" :opacity="scroll" layout="center" :buttons="navButtons"></uni-nav-bar>
		<div class="app-container full">
			...
			<view class="user-count">
				<text>{{userInfo.usercount}}</text>
			</view>
			<view class="status-box" style="padding:20upx 40upx;">
				<view class="left-status">
					<text style="font-size:30upx;font-family:'Montserrat-Light';color:#fff;">2019/02/04 01:13</text>
					<text style="font-size:26upx;color:#999;">创建日期</text>
				</view>
				<view class="right-status">
					<text style="font-size:30upx;color:#fff;">充值成功</text>
			...
			<view class="fun-card" style="margin:30upx 40upx;width:670upx;">
				<view class="fun-card-item">
					...
					<view class="form-item">
						<view class="input-field">
							...
							<view>
								<text style="color:#fff;font-size: 28upx;font-family:'Montserrat-Light';">10Xdog</text>
								<text style="display: inline-block;font-size:24upx;padding:0upx 20upx;color:#999;font-family:'Montserrat-Light';">|</text>
								<text style="font-size: 24upx;color:#999;font-family:'Montserrat-Light';">0.3%</text>
							</view>
						</view>
					</view>
					<view class="form-item" style="padding-bottom: 0px;">
						<text style="font-size: 24upx;color:#999;">备注：飞鱼</text>
					</view>
				</view>
				...
				<view class="fun-card-item">
					<view class="status-box">
						<view class="left-status">
							<text style="font-size:28upx;font-family:'Montserrat-Light';color:#fff;">0xEc9***x34e518da</text>
