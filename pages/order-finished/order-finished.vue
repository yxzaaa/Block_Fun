	...
	<view>
		...
		<view class="topay">
			<view style="display: flex;flex-direction: column;">
				<span style="font-family: PingFang SC;color:#fff;font-size: 32upx;">已完成</span>
				<span style="font-family: PingFang SC;color:#999999;font-size: 24upx;margin-top:12upx;">
					您已确认收货
				</span>
			</view>
			<view style="width:217upx;height:136upx;">
				<image src="../../static/bg/finish.png" style="width:217upx;height:136upx;display: block;"></image>
			</view>
		</view>
