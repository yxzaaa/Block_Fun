	...
	<view>
		...
		<view class="topay">
			<view style="display: flex;flex-direction: column;">
				<span style="font-family: PingFang SC;color:#fff;font-size: 32upx;">已取消</span>
				<span style="font-family: PingFang SC;color:#999999;font-size: 24upx;margin-top:12upx;">
					订单已被取消
				</span>
			</view>
			<view style="width:74upx;height:88upx;">
				<image src="../../static/bg/cancel.png" style="width:74upx;height:88upx;display: block;"></image>
			</view>
		</view>
